...
git remote add origin https://github.com/putrinuroktavia234-max/TunnelingYouzinCrabz.git
...
Cari dan ganti:
```
https://github.com/putrinuroktavia234-max/TunnelingYouzinCrabz
```
...
Baris 48-49, ganti:
```bash
wget -q --show-progress https://raw.githubusercontent.com/putrinuroktavia234-max/TunnelingYouzinCrabz/main/tunnel.sh
```

### 3. tunnel.sh
Baris 22, ganti:
```bash
SCRIPT_URL="https://raw.githubusercontent.com/putrinuroktavia234-max/TunnelingYouzinCrabz/main/tunnel.sh"
```
...
```markdown
![GitHub stars](https://img.shields.io/github/stars/putrinuroktavia234-max/TunnelingYouzinCrabz?style=social)
![GitHub forks](https://img.shields.io/github/forks/putrinuroktavia234-max/TunnelingYouzinCrabz?style=social)
![GitHub issues](https://img.shields.io/github/issues/putrinuroktavia234-max/TunnelingYouzinCrabz)
![GitHub last commit](https://img.shields.io/github/last-commit/putrinuroktavia234-max/TunnelingYouzinCrabz)
...
### Issues
```
https://github.com/putrinuroktavia234-max/TunnelingYouzinCrabz/issues
```

### Discussions
```
https://github.com/putrinuroktavia234-max/TunnelingYouzinCrabz/discussions
```
